-- SQL script for initializing Scolarise database on Supabase client
...
-- Enable RLS for all tables (Supabase defaults) but make sure to allow public access for anonymity
...
-- Creating anonymous credentials policy for select, insert, update and delete (Full CRUD access)
